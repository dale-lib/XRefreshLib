...
import static com.dale.refresh.util.DensityUtil.dp2px;
import static com.dale.refresh.util.SmartUtil.fling;
import static com.dale.refresh.util.SmartUtil.getColor;
import static com.dale.refresh.util.SmartUtil.isContentView;
...
import com.dale.refresh.api.DefaultRefreshFooterCreator;
import com.dale.refresh.api.DefaultRefreshHeaderCreator;
import com.dale.refresh.api.DefaultRefreshInitializer;
import com.dale.refresh.api.RefreshContent;
import com.dale.refresh.api.RefreshFooter;
import com.dale.refresh.api.RefreshHeader;
import com.dale.refresh.api.RefreshInternal;
import com.dale.refresh.api.RefreshKernel;
import com.dale.refresh.api.RefreshLayout;
import com.dale.refresh.api.ScrollBoundaryDecider;
import com.dale.refresh.constant.DimensionStatus;
import com.dale.refresh.constant.RefreshState;
import com.dale.refresh.constant.SpinnerStyle;
import com.dale.refresh.footer.BallPulseFooter;
import com.dale.refresh.header.BezierRadarHeader;
import com.dale.refresh.impl.RefreshContentWrapper;
import com.dale.refresh.impl.RefreshFooterWrapper;
import com.dale.refresh.impl.RefreshHeaderWrapper;
import com.dale.refresh.listener.OnLoadMoreListener;
import com.dale.refresh.listener.OnMultiPurposeListener;
import com.dale.refresh.listener.OnRefreshListener;
import com.dale.refresh.listener.OnRefreshLoadMoreListener;
import com.dale.refresh.listener.OnStateChangedListener;
import com.dale.refresh.util.DelayedRunnable;
import com.dale.refresh.util.DensityUtil;
import com.dale.refresh.util.ViscousFluidInterpolator;
...
//    }
     ...
     * Recommended {@link com.dale.refresh.listener.SimpleMultiPurposeListener}
     * 设置多功能监听器
     * 建议使用 {@link com.dale.refresh.listener.SimpleMultiPurposeListener}
     *
     ...
     * Recommended {@link com.dale.refresh.impl.ScrollBoundaryDeciderAdapter}
     * 设置滚动边界判断器
     * 建议使用 {@link com.dale.refresh.impl.ScrollBoundaryDeciderAdapter}
     *
